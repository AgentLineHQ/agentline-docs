...
- Phone numbers are **US only** and cost **$2.00/month per number**. Calls are **$0.10/min**, billed per second. Do not document Canada, a one-time number fee, `$0.08/min`, or `$0.02/msg`.
